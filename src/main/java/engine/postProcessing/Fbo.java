...
public class Fbo {
	...
	public void resolveToScreen() {
		...
		GL30.glBlitFramebuffer(0, 0, width, height, 0, 0, WindowManager.getCurrentWidth(), WindowManager.getCurrentHeight(), GL11.GL_COLOR_BUFFER_BIT, GL11.GL_NEAREST);
		this.unbindFrameBuffer();
	}
	...
	private void createMultisampleColorAttachment() {
		...
		GL30.glRenderbufferStorageMultisample(GL30.GL_RENDERBUFFER, Constants.MULTISAMPLES, GL11.GL_RGB8, width, height);
	...
	private void createDepthBufferAttachment() {
		...
		if(!multisample)
			...
			GL30.glRenderbufferStorageMultisample(GL30.GL_RENDERBUFFER, Constants.MULTISAMPLES, GL14.GL_DEPTH_COMPONENT24, width, height);
